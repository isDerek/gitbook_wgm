...
<table>
    ...
    <tr>
        <th> 2 </th>
        <th colspan = "8" align = "left"> [ OUT ] CMD ID = 0x0A </th>
    </tr>
    <tr>
        <th> 3 </th>
...
<table>
    ...
    <tr>
        <th> 2 </th>
        <th colspan = "8" align = "left"> [ IN ] CMD ID = 0x0A </th>
    </tr>
    <tr>
        <th> 3 </th>
    ...
    <tr>
        <th> 5 </th>
        <th colspan = "8" align = "left"> [ IN ] Data_Length = (1 位侧键标志位 + n 位组合键) </th>
    </tr>
    <tr>
        <th> 6 </th>
        <th colspan = "8" align = "left"> [ IN ] 自定义组合键一 </th>
    </tr>
    <tr>
        <th> 7 </th>
        <th colspan = "8" align = "left"> [ IN ] 自定义组合键二 </th>
    </tr>
    <tr>
        <th> 8 </th>
        <th colspan = "8" align = "left"> [ IN ] 自定义组合键三 </th>
    </tr>
    <tr>
        <th> ...... </th>
