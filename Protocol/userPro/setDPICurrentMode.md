...
<table>
    ...
    <tr>
        <th> 2 </th>
        <th colspan = "8" align = "left"> [ OUT ] CMD ID = 0x05 </th>
    </tr>
    <tr>
        <th> 3 </th>
    ...
    <tr>
        <th> 6 </th>
        <th colspan = "8" align = "left"> [ OUT ] DPICurrentMode = ( 0x00,0x01,0x02,0x03 ) </th>
    </tr>
    <tr>
        <th> ...... </th>
...
**DPICurrentMode = 0x00 ( 档位 0， DPI = 400 )**<br>
**DPICurrentMode = 0x01 ( 档位 1， DPI = 800 )**<br>
**DPICurrentMode = 0x02 ( 档位 2， DPI = 1600 )**<br>
**DPICurrentMode = 0x03 ( 档位 3， DPI = 4000 )**<br>
...
<table>
    ...
    <tr>
        <th> 2 </th>
        <th colspan = "8" align = "left"> [ IN ] CMD ID = 0x05 </th>
    </tr>
    <tr>
        <th> 3 </th>
